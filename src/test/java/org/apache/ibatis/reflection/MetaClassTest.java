...
public class MetaClassTest {
  ...
  public void shouldTestDataTypeOfGenericMethod() {
    MetaClass meta = MetaClass.forClass(GenericConcrete.class, new DefaultReflectorFactory());
  ...
  public void shouldCheckGetterExistance() {
    MetaClass meta = MetaClass.forClass(RichType.class, new DefaultReflectorFactory());
